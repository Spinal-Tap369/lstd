...
class LSTDModelConfig:
    ...
    L1_weight: float = 1.0 # paper-style sparse dependency penalty (L_s)
    L2_weight: float = 1.0 # paper-style smooth/attention penalty (L_m)

    #  Not used by the rewritten model.
    hidden_dim: int = 128
    hidden_layers: int = 2
    dropout: float = 0.0
